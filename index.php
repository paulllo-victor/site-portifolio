				...
				<div class="row grid">
					...
					<div class="single-portfolio col-sm-4 all mockup">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="asset/site/images/p1.jpg" alt="">
							</div>
							<a href="asset/site/images/p1.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="asset/site/images/preview.png" alt=""></div>
					...
					<div class="single-portfolio col-sm-4 all mockup">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="asset/site/images/p2.jpg" alt="">
							</div>
							<a href="asset/site/images/p2.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="asset/site/images/preview.png" alt=""></div>
								</div>
							</a>                                  
					...
					<div class="single-portfolio col-sm-4 all packaging">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="asset/site/images/p3.jpg" alt="">
							</div>
							<a href="asset/site/images/p3.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="asset/site/images/preview.png" alt=""></div>
								</div>
							</a> 
					...
					<div class="single-portfolio col-sm-4 all packaging">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="asset/site/images/p4.jpg" alt="">
							</div>
							<a href="asset/site/images/p4.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="asset/site/images/preview.png" alt=""></div>
								</div>
							</a>                                
					...
					<div class="single-portfolio col-sm-4 all typography">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="asset/site/images/p5.jpg" alt="">
							</div>
							<a href="asset/site/images/p5.jpg" class="img-pop-up">  
								<div class="middle">
									<div class="text align-self-center d-flex"><img src="asset/site/images/preview.png" alt=""></div>
								</div>
							</a>                                
					...
					<div class="single-portfolio col-sm-4 all photography">
						<div class="relative">
							<div class="thumb">
								<div class="overlay overlay-bg"></div>
								<img class="image img-fluid" src="asset/site/images/p6.jpg" alt="">
							</div>
							<a href="asset/site/images/p6.jpg" class="img-pop-up">  
								<div class="middle">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						<div class="block-47-image">
							<img src="asset/site/images/person_1.jpg" alt="Image placeholder" class="img-fluid">
						</div>
				...
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						<div class="block-47-image">
							<img src="asset/site/images/person_2.jpg" alt="Image placeholder" class="img-fluid">
						</div>
						<blockquote class="block-47-quote">
							<p>&ldquo;Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.&rdquo;</p>
				...
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						<div class="block-47-image">
							<img src="asset/site/images/person_3.jpg" alt="Image placeholder" class="img-fluid">
						</div>
						<blockquote class="block-47-quote">
							<p>&ldquo;Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.&rdquo;</p>
							<cite class="block-47-quote-author">&mdash; Ethan McCown, CEO <a href="#">XYZ Inc.</a></cite>
				...
				<div class="col-md-6">
					...
					<div class="block-47 d-flex mb-5">
						<div class="block-47-image">
							<img src="asset/site/images/person_4.jpg" alt="Image placeholder" class="img-fluid">
						</div>
						<blockquote class="block-47-quote">
							<p>&ldquo;Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.&rdquo;</p>
							<cite class="block-47-quote-author">&mdash; Craig Gowen, CEO <a href="#">XYZ Inc.</a></cite>
			...
			<div class="row">
				<div class="col-sm-6 col-lg-4 mb-4">
					<div class="blog-entry">
						<a href="#"><img src="asset/site/images/post_1.jpg" alt="Image placeholder" class="img-fluid"></a>
				...
				<div class="col-sm-6 col-lg-4 mb-4">
					<div class="blog-entry">
						<a href="#"><img src="asset/site/images/post_2.jpg" alt="Image placeholder" class="img-fluid"></a>
						<div class="blog-entry-text">
							<h3><a href="#">Creative Product Designer From Facebook</a></h3>
							<p class="mb-4">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
				...
				<div class="col-sm-6 col-lg-4 mb-4">
					<div class="blog-entry">
						<a href="#"><img src="asset/site/images/post_3.jpg" alt="Image placeholder" class="img-fluid"></a>
						<div class="blog-entry-text">
							<h3><a href="#">Creative Product Designer From Facebook</a></h3>
							<p class="mb-4">Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
